...
export function BookOpenIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M1.5 7.125c0-1.036.84-1.875 1.875-1.875h.75c1.036 0 1.875.84 1.875 1.875v9.75c0 1.035-.84 1.875-1.875 1.875h-.75A1.875 1.875 0 011.5 16.875v-9.75zM7.5 7.125c0-1.036.84-1.875 1.875-1.875h.75c1.036 0 1.875.84 1.875 1.875v9.75c0 1.035-.84 1.875-1.875 1.875h-.75A1.875 1.875 0 017.5 16.875v-9.75zM16.5 7.125c0-1.036.84-1.875 1.875-1.875h.75c1.036 0 1.875.84 1.875 1.875v9.75c0 1.035-.84 1.875-1.875 1.875h-.75a1.875 1.875 0 01-1.875-1.875v-9.75zM12 9.75A.75.75 0 0112.75 9h6a.75.75 0 010 1.5h-6A.75.75 0 0112 9.75zm-.75 2.25a.75.75 0 000 1.5h3a.75.75 0 000-1.5h-3z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        ...
        fill="currentColor"
      />
      <path d="M12.971 1.816A5.23 5.23 0 0114.25 5.25v1.875c0 .207.168.375.375.375H16.5a5.23 5.23 0 013.434 1.279 9.768 9.768 0 00-6.963-6.963z" fill="currentColor" />
    </svg>
  );
}

export function NewspaperIcon(props: PropsType) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <path
        ...
        fill="currentColor"
      />
      <path d="M18.75 6.75h1.875c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-2.25c-.621 0-1.125-.504-1.125-1.125V12.75a3 3 0 00-3-3h-1.5a3 3 0 00-3 3v6.75c0 .621-.504 1.125-1.125 1.125H5.625a1.125 1.125 0 01-1.125-1.125v-9.75A1.125 1.125 0 015.625 6.75H6.75a3 3 0 013-3h1.5a3 3 0 013 3H18z" fill="currentColor" />
    </svg>
  );
}
